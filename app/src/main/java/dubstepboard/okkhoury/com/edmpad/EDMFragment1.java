...
//    private loopingTask3 loopTask3 = new loopingTask3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        v = inflater.inflate(R.layout.fragment1_edm, parent, false);
        ...
        // set up the sounds
        final int sound1ID = spHold1.load(getActivity(), R.raw.ethereal1, 1);
        final int sound2ID = spHold2.load(getActivity(), R.raw.ethereal2, 1);
        final int sound3ID = spHold3.load(getActivity(), R.raw.ethereal3, 1);

        final int sound4ID = spNormal.load(getActivity(), R.raw.ethereal4, 1);
        final int sound5ID = spNormal.load(getActivity(), R.raw.ethereal5, 1);
        final int sound6ID = spNormal.load(getActivity(), R.raw.ethereal6, 1);
        final int sound7ID = spNormal.load(getActivity(), R.raw.ethereal7, 1);
        final int sound8ID = spNormal.load(getActivity(), R.raw.ethereal8, 1);
        final int sound9ID = spNormal.load(getActivity(), R.raw.ethereal9, 1);
        final int sound10ID = spNormal.load(getActivity(), R.raw.ethereal10, 1);
        final int sound11ID = spNormal.load(getActivity(), R.raw.ethereal11, 1);
        final int sound12ID = spNormal.load(getActivity(), R.raw.ethereal12, 1);
        ...
        setUpRegularButton(soundButton5, sound5ID, spNormal, R.raw.ethereal5);
        setUpRegularButton(soundButton6, sound6ID, spNormal, R.raw.ethereal6);
        setUpRegularButton(soundButton7, sound7ID, spNormal, R.raw.ethereal7);
        setUpRegularButton(soundButton8, sound8ID, spNormal, R.raw.ethereal8);
        setUpRegularButton(soundButton9, sound9ID, spNormal, R.raw.ethereal9);
        setUpRegularButton(soundButton10, sound10ID, spNormal, R.raw.ethereal10);
        setUpRegularButton(soundButton11, sound11ID, spNormal, R.raw.ethereal11);
        setUpRegularButton(soundButton12, sound12ID, spNormal, R.raw.ethereal12);
